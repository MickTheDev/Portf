...
const Skill = ({ directonLeft }: Props) => {
  return (
    ...
    >
      ...
      />
      <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white group-hover:bgwhite h-20 w-20 md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
